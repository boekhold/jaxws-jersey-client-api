 ...
 * 
 */
@WebServiceClient(name = "StockQuote", targetNamespace = "http://www.webserviceX.NET/", wsdlLocation = "file:/C:/Maarten/tmp/stockquote/stockquote.asmx.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/Maarten/tmp/stockquote/stockquote.asmx.wsdl");
